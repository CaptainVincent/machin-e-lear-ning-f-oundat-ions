...
> 如果預期結果是正時, 因內積的兩個向量夾角過大 (過大、過小以 90 度為界線) 才會是負, 所以修正方式是要往 **x** 方向靠近, 反之則要遠離 **x** (但不保證修正後的夾角即滿足需求)
...
> sign (**w**<sup>T</sup>**x**) 中, **w**<sup>T</sup>**x** = 0 在二維中是一條法相量為 **w** 的直線二分其結果 y, 在高維度時劃分結果 y 的則是法相量 **w** 的高維平面。
